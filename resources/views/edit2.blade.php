...
<body style="background-color: #f4f4f4;">
    <div>
        ...
        <main>
            ...
            <div class="box-mk1">
                <div class="box-mk2">
                    <h4 style="margin-top: 120px; text-align:center;">EDIT DATA PENJUALAN</h4>
                </div>
                <form action="/edit2">
                        <!-- hidden id -->
                        <input type="hidden" class="form-control" id="id" name="id" value="{{ $dataEdit->id }}"
                                aria-describedby="emailHelp">
                        <!-- end hidden id -->
                        <!-- form text field -->
                        <div class="mb-3">
                            <label for="exampleInputText" class="form-label">Nama Pembeli</label>
                            <input type="text" class="form-control" id="nama_pembeli" name="nama_pembeli" value="{{ $dataEdit->nama_pembeli }}" style="width: 500px;"
                                aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_telp" name="no_telp" value="{{ $dataEdit->no_telp }}" style="width: 500px;"
                                aria-describedby="emailHelp">
                            <div id="emailHelp" class="form-text">Ex: 085xxxxxx</div>
                        </div>
                        <!-- end form text field -->
                        <div class="mb-3">
                            <label for="exampleInputText" class="form-label">Nama Obat</label>
                            <div class="mb-3">
                                <select class="form-selected" aria-label="Default select example" name="obat" id="obat">
                                    <option selected>Pilih Barang</option>
                                    @foreach ($obat as $dat)
                                        <option value="{{ $dat->id }}" {{ $dat->id == $dataEdit->id_layanan ? 'selected' : '' }}>
                                            {{ $dat->nama_obat }}
                                        </option> 
                                    @endforeach
                                </select>  
