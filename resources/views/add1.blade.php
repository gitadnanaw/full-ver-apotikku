...
<body style="background-color: #f4f4f4;">
    <div>
        ...
        <main>
            ...
            <div class="box-mk1">
                <div class="box-mk2">
                    <h4 style="margin-top: 120px; text-align:center;">INPUT OBAT</h4>
                </div>
                <form action="/add">
                        <!-- form text field -->
                        <div class="mb-3">
                            <label for="exampleInputText" class="form-label">Merk Obat</label>
                            <input type="text" class="form-control" id="nama_obat" name="nama_obat" style="width: 500px;"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="harga" name="harga" style="width: 500px;"
                                aria-describedby="emailHelp">
